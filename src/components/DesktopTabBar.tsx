...
export function DesktopTabBar({ state, navigation }: TabBarProps) {
  ...
  return (
    <View style={[styles.sidebar, { backgroundColor: theme.card, borderRightColor: theme.border }]}>
      ...
      <View style={styles.logoRow}><View style={[styles.logo, { backgroundColor: theme.blue }]}><Ionicons name="flash" color="#fff" size={14} /></View><Text style={[styles.brandName, { color: theme.text }]}>FeedMind</Text></View>
...
const styles = StyleSheet.create({
  ...
  logoRow: { height: 56, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8 }, logo: { width: 25, height: 25, borderRadius: 6, alignItems: 'center', justifyContent: 'center', marginRight: 12 }, brandName: { fontSize: 17, fontWeight: '800' },
